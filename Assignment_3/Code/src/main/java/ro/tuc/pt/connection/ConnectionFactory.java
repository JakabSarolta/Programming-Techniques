...
/**
 *
 * The ConnectionFactory class connects the Java code with the Order_management MySQL database.
...
public class ConnectionFactory {
    ...
    private static final String PASS = "unicorn";
